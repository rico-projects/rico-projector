...
//                parent.add(new Separator(), "spanx 2, grow, wrap");
        ...
        private Node createTextField(PropertySheetTextFieldItemModel itemModel) {
            dev.rico.internal.client.projector.uimanager.TextField field = new dev.rico.internal.client.projector.uimanager.TextField(controllerProxy, itemModel.getField());
        ...
        private Node createTextArea(PropertySheetTextAreaItemModel itemModel) {
            dev.rico.internal.client.projector.uimanager.TextArea field = new dev.rico.internal.client.projector.uimanager.TextArea(controllerProxy, itemModel.getField());
            field.editableProperty().bind(wrapBooleanProperty(itemModel.readOnlyProperty()).not());
            return field;
        }
